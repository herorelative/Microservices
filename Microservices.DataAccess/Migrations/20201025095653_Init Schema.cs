        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxBuyLimit = table.Column<int>(nullable: false),
                    MaxBuyGiftLimit = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscountOnPaymentMethod = table.Column<int>(nullable: false),
                    Quantity = table.Column<int>(nullable: false),
                    BuyType = table.Column<short>(nullable: false),
                    IsActive = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_evoucher", x => x.Id);
                });
